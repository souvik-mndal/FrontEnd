    ...
    return (
        <div className="w-full shadow-md h-[80px]">
            <div className="w-[1200px] h-full mx-auto flex items-center  justify-between">
                <div id="part1" className="flex items-cente ">
                    ...
                    <div className="flex items-center ml-8">
                        <h3 className="font-bold text-sm border-b-2 border-black cursor-pointer hover:text-[#FF5622] hover:border-[#FF5622] ">Order</h3>
                        <i className="ri-arrow-down-s-line ml-4 text-[#FF5622] text-2xl"></i>
                    </div>
                </div>
                <div id="part2" className="flex items-center h-full w-[62.5%] justify-between ">
                    <div className="flex hover:text-[#FF5622]">
                    ...
                    <div className="flex hover:text-[#FF5622] relative" >
